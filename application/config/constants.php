...
defined('MEMBER')              or define('MEMBER', 'P'); // penomoran awal PELANGGAN
defined('DIGIT_MEMBER')        or define('DIGIT_MEMBER', '%06s'); // jumlah digit transaksi misal : P-000001
defined('NOMOR_REFF')           or define('NOMOR_REFF', 'REF-'); // penomoran awal kas
