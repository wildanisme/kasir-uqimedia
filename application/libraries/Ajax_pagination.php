...
class Ajax_pagination{
    ...
    var $num_links       =  2;
    var $cur_page        =  0;
    var $first_link      = '<i class="fa fa-step-backward" aria-hidden="true"></i>';
    var $next_link       = '<i class="fa fa-angle-right"></i>';
    var $prev_link       = '<i class="fa fa-angle-left"></i>';
    var $last_link       = '<i class="fa fa-step-forward" aria-hidden="true"></i>';
    var $uri_segment     = 3;
    var $full_tag_open   = '<ul class="pagination pagination-responsive float-right">';
    ...
    var $loading         = '.loading';
    var $show_tag_open   = '<ul class="pagination pagination-responsive float-left">';
    var $show_tag_close  = '</ul>';
	var $link_info_l	= '<li class="page-item disabled "><a href="#" class="page-link">';
	var $link_info_r	= '</a></li>';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<span class="tampil">Menampilkan : ' . $this->total_rows . '</span>';
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info = $this->link_info_l .'Menampilkan ' . ( $curr_offset + 1 ) . ' - ' ;
            ...
            $info .= ' dari ' . $this->total_rows . $this->link_info_r;
            $output2 .= $info;
        }
        ...
        $output = $this->show_tag_open.$output2.$this->show_tag_close . $this->full_tag_open.$output.$this->full_tag_close;
        ?>
        <script>
