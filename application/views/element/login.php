...
<html lang="en">
    <head>
        ...
        <style>
            ...
            background: linear-gradient(45deg,#330066,#001a66);
            border-radius: 30px;
            }
    ...
    <body class="bg-gradient-login"> 
        <div class="container h-100">
            <div class="row h-100 justify-content-center align-items-center">
                <form class="col-md-9 user" method="POST" action="<?=base_url();?>adm/index">
                            ...
                            <div class="col-md-6 d-flex justify-content-center align-items-center">
                                <div class="col-md-10 AppFormLeft">
                                    ...
                                    <div class="form-group position-relative mb-4">
                                        <input type="text" class="form-control border-top-0 border-right-0 border-left-0 rounded-0 shadow-none" name="email_user" id="email_user" value="<?=$email;?>" placeholder="Email" required="">
