		...
		<div class="invoice-box">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td colspan="2" class="tgl">NOTA PEMBELIAN</td>
				</tr>
				<tr class="">
					<td colspan="2">Serang, <?=tgl_indo($cetak['tgl_pembelian']);?></td>
				</tr>
				<tr class="">
					<td colspan="2"></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2">NOMOR. #<?=$cetak['id_pembelian'];?></td>
				</tr>
			</table>
			<table style="width:100%;margin-top:5px" cellpadding="0" cellspacing="0">
				...
				<?php 
					...
					?>
					<tr class="item">
						<td class="border"><?=getBahan($val['id_bahan']);?></td>
			...
			<table class="table" style="width:100%;margin-top:10px" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td colspan="2">Jenis Bayar : <?=getJenisBayar($cetak['id_bayar']);?></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td class="total1" style="width:12%">Total</td>
					<td class="total2" style="width:19%"><?=rp($totalb);?></td>
				</tr>
				<?php if(!empty($cetak['tgl_jatuhtempo'])){ ?>
				<tr>
					<td colspan="2">Jatuh Tempo : <?=dtime($cetak['tgl_jatuhtempo']);?></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
