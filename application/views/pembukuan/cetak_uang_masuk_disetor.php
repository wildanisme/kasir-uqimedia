...
<body>
	...
	<div class="invoice-box">
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr class="">
				<td colspan="2">Bogor, <?= tgl_indo(date('Y-m-d')); ?></td>
			</tr>
			<tr class="">
				<td colspan="2"></td>
			</tr>
			...
			<tr class="kepada">
				<td class="tkepada">Tanggal Setor</td>
				<td class="bawah"><?= tgl_ambil($tanggal); ?></td>
			</tr>
			<tr class="">
				<td colspan="2"></td>
			</tr>
		...
		<table style="width:100%;margin-top:5px" cellpadding="0" cellspacing="0">
			<tr class="heading">
				...
				<td class="ket">Tgl. Order</td>
				<td class="ket">Tgl. Bayar</td>
			...
			?>
					<tr>
						...
						<td class="ket"><?php echo dtimes($row['tgl_trx'], false, false); ?></td>
						<td class="ket"><?php echo dtimes($row['tgl_bayar'], false, false); ?></td>
						<td class="ket"><?php echo $row['nama']; ?></td>
						<td class="ket"><?php echo $row['nama_bayar']; ?></td>
