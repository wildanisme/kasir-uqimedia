...
<html>
	<head>
		...
		<style>
			...
			.qrcode{position:absolute;right:0;top:0;right:10px}
		</style>
					...
					<div class="row main-section">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 text-left">
							...
							<div class="qrcode" style="width:80px; height:80px;">
								<img src="<?=base_url();?>uploads/qrcode/qris.png" alt="" style="width:80px; height:80px;" />
							</div>
						</div>
									...
									<tbody>
										<?php
											...
											<tr>
												...
												<td class="text-right"><?=$val['jumlah'].' '.$satuan;?></td>
