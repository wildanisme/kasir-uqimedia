	...
	<body>
		...
		<div class="invoice-box">
			...
			<table style="width:100%;margin-top:5px" cellpadding="0" cellspacing="0">
				<tr class="heading">
					<td align="left" style="width:8%!important">qty</td>
					<td style="width:15%!important">Produk</td>
					<td style="width:20%!important">Nama Barang/Merk</td>
					<td>Keterangan</td>
					<td align="right" style="width:10%!important">Ukuran</td>
				...
				<tr>
					<td width="11%" rowspan="5" align="left" style="width:35%!important"><?php
						if($alt=='BATAL'){
							...
							// print_r($cetak);
						?>
						BAYAR : <?php if($total->total!=0){ if(isset($cara)){ echo strtoupper($cara->nama_bayar);}}else{echo "PIUTANG";}} 
						if($cashback > 0)
						{
					...
					<span style="font-size:12pt;line-height:12px">
				...
				<?php 
					...
					foreach($bdetail AS $val){
						if($sisa==0 AND $cdetail==1 AND $val['jml_bayar']==$cek_bayar){
							...
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td class="lunas1">Jumlah Bayar</td>
							<td class="lunas2">'.rp($jumlah_bayar).'</td>
							</tr>';
							echo '<tr class="lunas">
							<td>&nbsp;</td>
							<td>&nbsp;</td>
