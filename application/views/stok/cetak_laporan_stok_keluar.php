			...
			<div class="invoice-box">
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td colspan="2" class="tgl">LAPORAN STOK KELUAR</td>
					</tr>
					<tr class="">
						<td colspan="2"><?=getBahan($id);?></td>
					</tr>
					<tr class="">
						<td colspan="2"></td>
					</tr>
				...
				<table style="width:100%;margin-top:5px" cellpadding="0" cellspacing="0">
					<tr class="heading">
						...
						<td class="">Tanggal</td>
						<td class="total">Stok Keluar</td>
						<td class="total" style="width:16%!important">Keterangan</td>
					</tr>
					<?php 
						...
						<tr class="item">
							...
							<td class='borderl'><?=dtimes($row->create_date);?></td>
							<td class='borderr total'><?=$row->jumlah;?></td>
							<td class='borderr total'><?=$row->ket;?></td>
						</tr>
						<?php $no++; }
						
					?>
					<tr class="item">
						<td colspan="2" class="borderl" align="right">Total</td>
						<td class='borderr total'><?=$total;?></td>
						<td class='borderr total'></td>
					</tr>
				</table>
				<table class="table" style="width:100%;margin-top:50px;margin-left:5%" cellpadding="0" cellspacing="0">
					<tr>
						<td colspan="3"><?=$info['keywords'];?> , <?=tgl_indonesia(date('Y-m-d'));?></td>
					</tr>
					<tr>
						<td align="left"><?=jabatan('owner');?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
